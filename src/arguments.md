...
Arguments to a verb are expressed as optional
[prepositional phrases](./prepositional-phrases.md). As a result, arguments have
no fixed order, and a single verb can take multiple arguments of the same
semantic role.
...
However, sometimes order does matter, for instance when
[universal and existential quantification](./determiner-phrases.md#ordering-determiner-phrases)
are involved.

In the next example, the ball and glove are thrown as part of the same action:

<gloss>
jə  | ŋɪ  | gɪ  | ðaz  | ŋɪ  | gɪ  | xop   | cɪ | kwʊ | θɪ  | wis
