...
exceptions to this pattern of predictability: the **subject** ({ŋiθ}) and
...
Many verbs also permit a secondary relational argument, marked using {qə}, which
...
<gloss>
jə  | qə | ŋɪ  | kwʊ | ŋiθ   | ŋɪ  | kwʊ | zim
sɴs | of | sʙᴊ | I   | exist | sʙᴊ | I   | want
I want to exist. (I want that I exist.)
</gloss>

For a given Najan verb, the meanings of {ŋɪ} and {qə} may or may not align well
