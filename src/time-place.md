...
2. {wɪ} for movement to or into a point or region
3. {xu} for movement from, away from, or out of
4. {zi} for movement through, throughout, or across

Each of these prepositions is inclusive; i.e. {wɪ} includes the destination,
...
argument refers to the spatio-temporal location of that object; e.g. {lɪ kwʊ}
...
Najan, each of these relations would use the same (locative) preposition: {zə lɪ
zə cats qə muð dan}, _a chair at a table_.
...
since the preposition {wɪ} (_to_) is always inclusive of the specified
destination, {wɪ gɪ tθak} (_to the end_) means that the expression holds true up
to and including the end. To convey that the expression held true up to (but not
necessarily including) some time before the end, one could say {wɪ zə qə gɪ tθak
