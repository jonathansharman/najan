...
| {zə}       | Indefinite   | a/an       |
| {gɪ}       | Definite     | the        |
| {sʊ}       | Distributive | each/every |
| {ðʊ}       | Generic      | in general |

The **indefinite determiner** {zə} introduces a new specific instance of the
...
The **definite determiner** {gɪ} refers to a known instance of the complement.
...
<gloss>
fʊ   | ŋɪ  | sʊ   | vɪx      | fxɪ | cay
ʀᴘʀᴛ | sʙᴊ | each | language | ʜᴀʙ | change
Every language changes.
</gloss>

The **generic determiner** {ðʊ} refers to the complement in a general,
...
<gloss>
jə  | cɪ | gɪ  | paŋ | dzað  | ŋɪ  | paŋ | θɪ  | khic
...
<gloss>
jə  | qə | ðʊ  | mə | bloθ  | qə | ðʊ  | lec   | can
...
Najan, the word for _rock_, {kut}, means _to be made of stone_. Thus {zə kut},
