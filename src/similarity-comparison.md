...
The comparative particle {vɪ} means roughly _than_ or _in comparison to_, but
...
A comparative argument can be combined with the
[distributive determiner](./determiner-phrases.md) {sʊ} to form a superlative:

<gloss>
jə  | vɪ   | sʊ   | tez   | ŋɪ  | kwʊ | ruθ
